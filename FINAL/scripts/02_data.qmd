...
<!--# The 'chem_packages.R file installs/loads required packages for the section, sets a seed (for reproducibility) and loads flextable defaults. -->

<!--# It uses conditional logic to only load packages needed for the section.  This is to enable updating and knitting sections separately, as stand-alone output.  -->

<!--# Refer to the R script for additional details. -->
